...
public class Follow extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String curr = request.getParameter("currentUser");
        String prof = request.getParameter("userProfile");
        
        
        if(action.equals("follow")){
            us.addFollow(prof, curr);
        }else{
            us.removeFollow(prof, curr);
        }
        
        
        request.setAttribute("username", prof);
